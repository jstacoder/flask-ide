...
function getIconNameFromIndex(idx) {
    return $("dd").eq(idx).children().attr("class").split(' ')[1]
}
...
$(function(){                     
    $(document).on("click","#select",function(){
       ...
       var icon = getIconNameFromIndex($("#myModal").data("current_index"));
       window.location = '/about?name='+name+'&description='+description+'&icon='+icon;
    });
